...
print("this is lnn-ogt_trainer.py")
...
if not os.path.exists('../lnn_weights'):
    os.makedirs('../lnn_weights')
...
def train_model():
    ...
    # Save the model
    save_path = '../lnn_weights/lnn_ogt.pth'
...
plt.savefig('lnn_ogt_prediction_vs_actual.png')
plt.show()